...
После установки зависимостей и настройки окружения необходимо выполнить скрипт `initLocal.sh`, который подготовит все необходимое для корректной работы проекта:
